...
//
// Layout:
//   [Left: Hierarchy Panel | 3-D View | Right: Export Panel]
...
int main(int argc, char** argv)
{
	...
	viewer.getCamera()->setViewport(PANEL_W, 0, WIN_W - PANEL_W - RPANEL_W, WIN_H);
	double fovY = 45.0;
	double ar = (double)(WIN_W - PANEL_W - RPANEL_W) / (double)WIN_H;
	...
	viewer.addEventHandler(new PanelHandler(
		panel.get(), exportPanel.get(), manip.get(),
